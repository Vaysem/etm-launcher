...
![Image alt](https://github.com/Vaysem/etm-launcher/blob/main/src-tauri/icons/favicons.ico) Безпечний та сучасний HTML лаунчер для локальних файлів "file:///" який використовує власне розширення etm. По суті це аналог застарілого .hta Але з сучасними можливостями css/html/js. Та параноїдальною тендннцію безпеки, як і у всіх сучасних браузерів - відносно до локальних файлів.
